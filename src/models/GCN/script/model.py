...
class GCNBlock(nn.Module):
    def __init__(self, in_feats, hid_feats, out_feats):
        ...
        self.conv1 = dglnn.GraphConv(in_feats=in_feats, out_feats=hid_feats, allow_zero_in_degree=True)
        self.conv2 = dglnn.GraphConv(in_feats=hid_feats, out_feats=out_feats, allow_zero_in_degree=True)
