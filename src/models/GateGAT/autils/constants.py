...
BINARIES_PATH = os.path.join(os.path.dirname(__file__), os.pardir, 'amodels', 'binaries')
CHECKPOINTS_PATH = os.path.join(os.path.dirname(__file__), os.pardir, 'amodels', 'checkpoints')
